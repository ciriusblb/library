...
var express=require('express'),
	...
	//router.use(isLoggedIn); // asi todas las rutas estaran protegidas por el middlewares
	...
	router.route('/admin/crear-libro')
		.get(isLoggedIn,function(req,res){//primero pasa por el isLoggedIn y luego ejecuta la funcion
